...
class Car:
    ...
    def log_motor_data(self, left_power, right_power, x_pos, y_pos, x_orient, y_orient):
        register = 0x04
        vel = 30/2
        if left_power == right_power:
            print("Velocity: ", vel, "cm/s")
        else:
            print("velocity: ", vel*0, "cm/s")
        print("X Position: ", x_pos)
        print("Y Position: ", y_pos)
        if x_orient == 0 and y_orient == 1:
            print("Orientation: North")
        elif x_orient == 0 and y_orient == -1:
            print("Orientation: South")
        elif x_orient == -1 and y_orient == 0:
...
class MinimalSubscriber(Node):
    ...
    def data_callback(self, msg):
        self.car.log_motor_data(msg.data[0], msg.data[1], msg.data[2], msg.data[3], msg.data[4], msg.data[5])
